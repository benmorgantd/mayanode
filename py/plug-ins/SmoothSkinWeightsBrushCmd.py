...
class SmoothSkinWeightsBrushCmd(om.MPxCommand):
    ...
    def __init__(self):
        super(SmoothSkinWeightsBrushCmd, self).__init__()
...
def cmdCreator():
    return SmoothSkinWeightsBrushCmd()


def initializePlugin(mObject):
    mPlugin = om.MFnPlugin(mObject)
    try:
        mPlugin.registerCommand(SmoothSkinWeightsBrushCmd.COMMAND_NAME, cmdCreator)
    except:
        sys.stderr.write('Failed to register command {}'.format(SmoothSkinWeightsBrushCmd.COMMAND_NAME))


def uninitializePlugin(mObject):
    mPlugin = om.MFnPlugin(mObject)
    try:
        mPlugin.deregisterCommand(SmoothSkinWeightsBrushCmd.COMMAND_NAME)
    except:
        sys.stderr.write('Failed to unregister command {}'.format(SmoothSkinWeightsBrushCmd.COMMAND_NAME))
